...
__all__ = [ 'Color', 'OLE_COLOR', 'OLE_OPTEXCLUSIVE',
           'OLE_YSIZE_HIMETRIC', 'OLE_XPOS_PIXELS', 'Picture',
           'OLE_YPOS_CONTAINER', 'FONTSTRIKETHROUGH', 'Unchecked',
           'OLE_XSIZE_HIMETRIC', 'IPictureDisp', 'OLE_YPOS_PIXELS',
           'OLE_XPOS_CONTAINER', 'FONTUNDERSCORE', 'StdFont',
           'OLE_CANCELBOOL', 'LoadPictureConstants', 'FONTBOLD',
           'OLE_YSIZE_PIXELS', 'IFontEventsDisp',
           'OLE_XSIZE_CONTAINER', 'Checked', 'Monochrome',
           'OLE_HANDLE', 'Font', 'FONTITALIC', 'OLE_TRISTATE',
           'Default', 'FontEvents', 'VgaColor', 'IPicture',
           'IFontDisp', 'StdPicture', 'OLE_XPOS_HIMETRIC', 'FONTNAME',
           'OLE_YSIZE_CONTAINER', 'OLE_XSIZE_PIXELS', 'Gray',
           'FONTSIZE', 'IFont', 'OLE_YPOS_HIMETRIC',
